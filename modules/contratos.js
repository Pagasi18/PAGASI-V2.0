  ...
  <div style="display:grid;grid-template-columns:1fr 1.4fr;gap:12px">
    <div class="card">
      ...
      <div class="fgr c1" style="gap:9px;margin-top:12px">
        ...
        <div class="fg"><label> Tipo de documento</label><select class="fs" id="sel-tipo-doc" onchange="renderContrato()"><option value="dra">Compraventa con Reserva de Dominio + Cesión (versión del abogado)</option><option value="contrato">Contrato completo · Venta + Cesión (predeterminado)</option><option value="venta">Solo el Contrato de Venta · Agente de Cobro</option><option value="cesion">Solo el Contrato de Cesión de Cuotas</option><option value="ambos">Venta y Cesión como dos documentos separados</option><option value="pagare">Pagaré</option><option value="carta">Carta de Instrucciones</option><option value="arriendo">Contrato de Arrendamiento con Opción a Compra (anterior)</option></select></div>
      </div>
