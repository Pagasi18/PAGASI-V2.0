  ...
  <div style="display:grid;grid-template-columns:1fr 1.4fr;gap:12px">
    <div class="card">
      ...
      <div class="fgr c1" style="gap:9px;margin-top:12px">
        ...
        <div class="fg"><label> Tipo de documento</label><select class="fs" id="sel-tipo-doc" onchange="renderContrato()"><option value="contrato">Contrato de Venta en Cuotas · Agente de Cobro</option><option value="cesion">Contrato de Cesión de Cuotas · Concesionario → Pagasi</option><option value="ambos">Ambos contratos juntos (Venta + Cesión)</option><option value="unificado">Contrato único (Venta + Cesión en un solo documento)</option><option value="pagare">Pagaré</option><option value="carta">Carta de Instrucciones</option><option value="arriendo">Contrato de Arrendamiento con Opción a Compra (anterior)</option></select></div>
      </div>
