...
function _wzRender(motoId){
  ...
  var step1 = '<div class="fg" style="margin-bottom:10px"><label class="fsec" style="display:block;margin-bottom:5px">Cliente registrado</label>'
    ...
    + '<button type="button" onclick="_wzCliClear()" style="border:none;background:rgba(255,71,87,.12);color:var(--red);width:26px;height:26px;border-radius:6px;cursor:pointer;font-size:14px;font-weight:700">×</button>'
    + '</div>'
...
function restaurarCred(credId){
  ...
  $('mic').textContent='↺'; $('mtt').textContent='Restaurar Crédito'; $('msb').textContent=c.id+' · '+c.cli;
  $('modal-box').className='modal';
