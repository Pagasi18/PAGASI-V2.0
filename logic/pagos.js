...
<div class="fg"><label>Recibido en</label><select class="fs" id="p_forma">${(_cuentasBanc&&_cuentasBanc.length?_cuentasBanc:[]).map(c=>`<option value="${c.nombre}">${c.nombre}</option>`).join('')}${(!_cuentasBanc||!_cuentasBanc.length)?'<option value="">— Sin cuentas configuradas —</option>':''}</select></div>
  ...
  S.saveFn=()=>{
    ...
    // â”€â”€ Lógica de cuotas con sobrante â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    if(ci>=0){
      ...
      if(cuotasPagadas>=totalCuotas && S.creds[ci].estado!=='completado'){
        ...
        // â”€â”€ Punto 5: Marcar cliente como premium si pagó sin mora â”€â”€
      ...
      pgSet('pagos',1);
      toast('âœ“ Pago registrado · '+fmt(monto),'success');
      // Ofrecer recibo
...
function openAmort(id){
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ DATOS ADICIONALES DEL CRÉDITO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  $('mbd').innerHTML=`
    <!-- â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â HEADER: Cliente + Estado â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â -->
    ...
    <!-- â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â PROGRESO VISUAL â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â -->
    ...
    <!-- â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â DATOS CLIENTE + DATOS CRÉDITO (2 columnas) â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â -->
    ...
    <!-- â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â FECHAS CLAVE + PRÓX PAGO â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â -->
    ...
    <!-- â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â TABLA DE AMORTIZACIÓN â•Ââ•Ââ•Ââ•Ââ•Ââ•Ââ•Â -->
...
function openEditPago(pagoId){
  ...
  $('mbd').innerHTML = '<div style="background:var(--surf2);border:1px solid var(--rim);border-radius:9px;padding:10px 12px;margin-bottom:12px;font-size:11px">'
    ...
    +'âœ“ El crédito se recalculará automáticamente al guardar cualquier cambio en el pago.</div>';
  S.saveFn = function(){
    ...
    recalcularCreditoDesdePagos(credId);
    calcularMoraAuto();
    closeM(); nav('pagos'); toast('Pago actualizado y crédito recalculado âœ“','success'); return true;
  };
  $('mft').innerHTML='<button class="btn btn-g" onclick="closeM()">Cancelar</button>'
...
function confirmarPago(pagoId){
  ...
  toast('âœ“ Pago confirmado · '+pagoId,'success');
  nav('pagos');
}

// â”€â”€ MORA: CALCULAR DÍAS AUTOMÁTICAMENTE AL CARGAR â”€â”€
